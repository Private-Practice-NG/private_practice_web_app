...
function JobsOutboxActiveJobs() {
  return (
    <>
      <section className="jobs-outbox-nav d-flex flex-row justify-content-between">
        <Link to="/jobs/job-outbox/open-jobs" className="header-item">
          open jobs
          <span> (6)</span>
        </Link>
        <Link to="/jobs/job-outbox/closed-jobs" className="header-item">
          closed jobs
          <span> (2)</span>
        </Link>
        <Link to="/jobs/job-outbox/completed-jobs" className="header-item">
          completed jobs
          <span> (4)</span>
        </Link>
        <Link
          to="/jobs/job-outbox/active-jobs"
        ...
        <section className="job-details-area pb-3 pt-3 pe-4 ps-4 font-bold">
          <div className="job-details-item border-bottom pb-3">
            ...
            <div className="job-extras-wrapper d-flex justify-content-between mt-2">
              ...
              <Link
                to="job-tracking"
                className="pe-5 ps-5 pt-2 pb-2 track-btn text-white ">
                Track Job
              </Link>
            </div>
          </div>
...
export default JobsOutboxActiveJobs;
