  ...
  return (
    <>
      <section className="jobs-outbox-nav d-flex flex-row justify-content-between">
        ...
        <Link
          to="/jobs/job-outbox/closed-jobs"
        ...
        <Link to="/jobs/job-outbox/active-jobs" className="header-item">
          active jobs
          <span> (1)</span>
        </Link>
      </section>
...
export default JobsOutboxClosedJobs;
