    ...
    <section className="bg-white m-5 open-sans practicing-profile">
      <header className="d-flex align-items-center justify-content-between px-4 py-3 border-bottom">
        <div className="d-flex align-items-center gap-3">
          ...
          <div>
            ...
            <p className="pt-1">Nasarrawa State, Nigeria</p>
          </div>
        </div>
      ...
      <section className="row">
        <div className="col-3 border-end">
          ...
          <div className="p-4 border-bottom">
            <p className="fs-5">Availability</p>
        ...
        <div className="col">
          <article className="p-4 border-bottom">
            ...
            <p className="pt-3">
              ...
              Exercitationem, similique alias. Explicabo necessitatibus fugit
              sunt odit dicta incidunt nam, tenetur aliquam placeat ad,
              consectetur eum, numquam nemo expedita voluptates sequi.
            </p>
            <p className="pt-3">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Numquam
              dolorum dolores repellat quas error asperiores et esse cum
              expedita velit libero, ratione, vero rerum sapiente dicta.
          ...
          <div className="pb-5">
            <div className="px-4 border-bottom">
              ...
              <div className="d-flex align-items-center gap-5 pt-2">
                <h4 className="fs-6">Completed (2)</h4>
                <h4 className="fs-6">In Progress (1)</h4>
              </div>
            </div>
            ...
            <section className="p-4 work-history">
              <div className="d-flex align-items-start gap-5">
                ...
                <p className="flex-fill work-date">
                  April 13, 2021 - April 18, 2021
                </p>
              </div>
            </section>
          </div>
