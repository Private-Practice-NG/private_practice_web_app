...
function RegistrationSectionRouteCenter() {
  return (
    <Routes>
      ...
      <Route path='/specialist-account-verified' element={<SpecialistAccountVerified />} />
      ...
      <Route path='/hospitals-enrolment-page' element={<HospitalsEnrolmentRequest />} />
      ...
      <Route path='/general-specialist-data-1' element={<GeneralSpecialistData1 />} />
      <Route path='/email-verification/:userType/:userId/verify/:token' element={<EmailVerification />} />
      <Route path='/verify-user-email' element={<VerifyUserEmail />} />
      <Route path='/verify-specialist-email' element={<VerifySpecialistEmail />} />
      <Route path='/verify-user-mobile-number' element={<VerifyUserMobileNumber />} />
      <Route path='/verify-specialist-mobile-number' element={<VerifySpecialistMobileNumber />} />
      <Route path='/mobile-number-verification_user' element={<MobileNumberVerificationUser />} />
      <Route path='/mobile-number-verification_specialist' element={<MobileNumberVerificationSpecialist />} />
      <Route path='/email-verification_user' element={<MailVerificationPage1 />} />
      <Route path='/email-verification_specialist' element={<MailVerificationPage2 />} />
      <Route path='/specialist-profile-summary' element={<ProfileSummaryPage />} />
      <Route path='/specialist-profile-setup-complete' element={<ProfileSetupComplete />} />
    </Routes>
  );
}

export default RegistrationSectionRouteCenter;
